<div>
    ...
    <div class="fixed inset-0 bg-slate-900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 opacity-0 pointer-events-none"
    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <!-- Logo -->
            <a class="block" href="http://127.0.0.1:8001/dashboard">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 bg-slate-900" x-data="{ open: 1 }">
                        <a class="block text-slate-200 truncate transition duration-150 hover:text-slate-200"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div
                                    ...
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 rotate-180"
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 !block" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block hover:text-slate-200 transition duration-150 truncate text-indigo-500"
                                ...
                                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 " x-data="{ open: 0 }">
                                    <a class="block text-slate-200 hover:text-white truncate transition duration-150 "
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div
                                                class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                                <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 rotate-0"
                                                    :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                                    <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"></path>
                                                </svg>
                                            </div>
                        ...
                        <div>
                            ...
                            <ul class="mt-3">
                                ...
                                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" x-data="{ open: false }">
                                    <a class="block text-slate-200 transition duration-150 hover:text-white"
                                    ...
                                    <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                        <ul class="pl-9 mt-1 hidden" :class="{ 'hidden': !open }">
                                            <li class="mb-1 last:mb-0">
                                                <form method="POST" action="http://127.0.0.1:8001/logout"
                                                    x-data="">
                                                    <input type="hidden" name="_token"
                                                        value="l14bvf24dlJgxxomMQC3Ie22ux13WSO4JybmXpaM">
                                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
                                                        href="http://127.0.0.1:8001/logout"

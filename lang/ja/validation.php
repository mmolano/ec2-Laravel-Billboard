...
return [
    ...
    */
    ...
    'doesnt_end_with' => ':attributeは以下で終わってはいけません: :values。',
    'doesnt_start_with' => ':attributeは以下で始まってはいけません: :values。',
    ...
    'missing' => ':attributeフィールドは存在しなければなりません。',
    'missing_if' => ':otherが:valueの場合、:attributeフィールドは存在しなければなりません。',
    'missing_unless' => ':otherが:valueでない限り、:attributeフィールドは存在しなければなりません。',
    'missing_with' => ':valuesが存在する場合、:attributeフィールドは存在しなければなりません。',
    'missing_with_all' => ':valuesが存在する場合、:attributeフィールドは存在しなければなりません。',
    'prohibits' => ':attributeフィールドは、:otherが存在しないようにする必要があります。',
    'required_array_keys' => ':attributeフィールドは、次のエントリが含まれていなければなりません: :values。',
